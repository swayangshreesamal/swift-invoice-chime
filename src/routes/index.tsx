  ...
  return (
    <div className="min-h-screen w-full bg-background text-foreground">
      ...
      <main className="mx-auto max-w-3xl pb-16">
        {/* Hero Section */}
        <section className="px-5 pt-8 pb-10 text-center sm:text-left">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-brand/30 bg-brand-soft/40 px-3 py-1 font-mono text-[11px] font-medium uppercase tracking-[0.14em] text-brand">
            <span>✨</span> For freelancers who hate chasing money
          </div>

          <h1 className="rise mt-4 text-balance font-display text-[2.4rem] sm:text-[3rem] font-semibold leading-[1.08] tracking-tight">
            Stop awkwardly chasing clients.
            <br />
            <span className="text-brand">Let PayReminder do the knocking.</span>
          </h1>

          <p className="rise mt-4 max-w-[44ch] text-pretty text-[16px] leading-relaxed text-muted-foreground">
          ...
          <div className="rise mt-6 flex flex-col sm:flex-row gap-3">
            <Link
              to={user ? "/dashboard" : "/auth"}
              className="btn-brand px-6 py-3.5 text-center text-[15px] font-medium shadow-sm"
            >
              Add your first invoice — Free
            </Link>
            <a href="#how" className="btn-quiet px-5 py-3.5 text-center text-[15px]">
              See how it works ↓
            </a>
          </div>

          <div className="mt-5 flex flex-wrap items-center justify-center sm:justify-start gap-4 text-xs text-muted-foreground">
            <span className="flex items-center gap-1.5">
              <span className="text-brand">✓</span> 0% Platform Commission
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-brand">✓</span> Direct UPI, PayPal &amp; Bank Wire
            </span>
            <span className="flex items-center gap-1.5">
              <span className="text-brand">✓</span> 3 Invoices Free Forever
            </span>
          </div>
        </section>
        ...
        <section id="how" className="px-5 pt-4">
          <div className="rounded-3xl border border-border bg-card/60 p-6 sm:p-7">
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="rounded-2xl border border-border bg-background/80 p-4">
                <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-soft text-brand font-mono font-bold text-sm">
                  1
                </div>
                <h3 className="mt-3 text-sm font-semibold">Add your invoice</h3>
              ...
              <div className="rounded-2xl border border-border bg-background/80 p-4">
                ...
                <h3 className="mt-3 text-sm font-semibold">Automatic follow-ups</h3>
                <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
              ...
              <div className="rounded-2xl border border-border bg-background/80 p-4">
                ...
                <h3 className="mt-3 text-sm font-semibold">Get paid directly</h3>
                <p className="mt-1 text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="mt-8 border-t border-border/60 pt-6">
              ...
              <div className="mt-3 grid grid-cols-1 sm:grid-cols-3 gap-3">
                {stages.map((s) => (
                  <div key={s.day} className={`rounded-2xl border p-4 ${s.tone}`}>
        ...
        <section className="px-5 pt-12">
          <div className="text-center sm:text-left">
            ...
            <p className="mt-1.5 text-sm text-muted-foreground">
              💡 <strong>Why Pro pays for itself:</strong> Recovering just one $500 unpaid invoice pays for more than 2 years of Pro.
            </p>
          </div>

          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {/* Free Card */}
            <div className="card-paper flex flex-col justify-between p-5">
              <div>
                ...
                <p className="mt-2 text-xs text-muted-foreground">
                  Perfect for freelancers starting out with a couple of clients.
                </p>

                <ul className="mt-5 space-y-2 text-xs text-muted-foreground">
                  <li className="flex items-center gap-2">
                    <span className="text-brand">✓</span> Up to 3 active invoices
                  </li>
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="text-brand">✓</span> 0% commission on payments
                  </li>
                </ul>
              </div>
              ...
              <Link
                to={user ? "/dashboard" : "/auth"}
                className="btn-quiet mt-6 block w-full py-2.5 text-center text-xs font-medium"
              >
            ...
            {/* Pro Card */}
            <div className="rounded-2xl border-2 border-brand bg-brand-soft/40 flex flex-col justify-between p-5 relative shadow-sm">
              <div className="absolute -top-3 right-4 rounded-full bg-brand px-2.5 py-0.5 font-mono text-[10px] font-semibold uppercase tracking-wider text-brand-foreground shadow-sm">
                Most Popular
              </div>
              ...
              <div>
                ...
                <ul className="mt-5 space-y-2 text-xs">
                  <li className="flex items-center gap-2 font-medium">
                    <span className="text-brand">✓</span> <strong>Unlimited</strong> active invoices
                  </li>
                  <li className="flex items-center gap-2 font-medium">
                    <span className="text-brand">✓</span> <strong>Automatic daily reminders</strong> (cron runs daily)
                  </li>
                  <li className="flex items-center gap-2 font-medium">
                    <span className="text-brand">✓</span> <strong>Multiple payment options</strong> &amp; 1-click links
                  </li>
                  <li className="flex items-center gap-2 font-medium">
                    <span className="text-brand">✓</span> <strong>Private client notes</strong> (track quirks)
                  </li>
                  <li className="flex items-center gap-2 font-medium">
                    <span className="text-brand">✓</span> <strong>Late fee warnings</strong> on final notices
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-brand">✓</span> Cancel anytime in 1 click from PayPal
                  </li>
                </ul>
              </div>
              ...
              <Link
                to="/pricing"
                className="btn-brand mt-6 block w-full py-2.5 text-center text-xs font-medium shadow-sm"
              >
        ...
        <section className="px-5 pt-14">
          ...
          <h2 className="mt-1 font-display text-2xl font-semibold tracking-tight text-center sm:text-left">
          ...
          <div className="mt-5 space-y-3">
            {faqs.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="rounded-2xl border border-border bg-card/60 p-4 transition-all"
                >
                  <button
                    type="button"
                  ...
                  {isOpen ? (
                    <p className="mt-2 text-xs leading-relaxed text-muted-foreground border-t border-border/40 pt-2">
                      {item.a}
                    </p>
                  ) : null}
                </div>
        ...
        <section className="mt-14 px-5">
          <div className="rounded-3xl border-2 border-brand bg-brand-soft/60 p-7 text-center">
            ...
            <div className="mt-5 flex justify-center">
              <Link
                to={user ? "/dashboard" : "/auth"}
                className="btn-brand px-7 py-3.5 text-[15px] font-semibold shadow-sm"
              >
